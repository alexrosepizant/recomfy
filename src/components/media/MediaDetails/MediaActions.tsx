...
import { useMediaStatus } from '../../../hooks/media/useMediaStatus';
...
export const MediaActions: React.FC<MediaActionsProps> = ({ media }) => {
  ...
  const { hasRead, hasWatched, toggleRead, toggleWatched } = useMediaStatus(media);
  const { addToHistory } = useMediaHistory();
